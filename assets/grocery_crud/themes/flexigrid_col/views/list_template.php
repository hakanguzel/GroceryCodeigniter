...
$this->set_js($this->default_theme_path . '/flexigrid_col/js/flexigrid.js');

$this->set_js($this->default_javascript_path . '/jquery_plugins/jquery.form.min.js');
$this->set_js($this->default_javascript_path . '/jquery_plugins/jquery.numeric.min.js');
$this->set_js($this->default_theme_path . '/flexigrid_col/js/jquery.printElement.min.js');

/* Fancybox */
//$this->set_css($this->default_css_path . '/jquery_plugins/fancybox/jquery.fancybox.min.css');
//$this->set_js($this->default_javascript_path . '/jquery_plugins/jquery.fancybox.min.js');
...
<div class="box box-primary">
    <div class="box-header with-border">
        <!--<h3 class="box-title"><i class="fa fa-table"></i> <?php //echo " " . $subject
                                                                ?></h3>-->
    ...
    <div class="box-body">
        <div class="flexigrid" data-unique-hash="<?php echo $unique_hash; ?>">
            ...
            <?php if (!$unset_add || !$unset_export || !$unset_print) { ?>
                <div class="tDiv row">
                    <div class="tDiv2 col-xs-6">
                        <?php if (!$unset_add) : ?>
                            <a href='<?php echo $add_url ?>' title='<?php echo ($subject ? $subject : $this->l('list_add')) . " "; ?>' class='add-anchor add_button btn btn-primary btn-flat'>
                                <i class="fa fa-plus-circle"></i>
                                <span class="add"><?php echo ($subject ? $subject : $this->l('list_add')); ?></span>
                            </a>
                        <?php endif ?>
                        <?php if (!$unset_delete) : ?>
                            <a href="<?php echo $delete_multiple_url ?>" class="btn btn-danger btn-flat delete-rows"><i class="fa fa-trash"></i> <?php echo $this->l('list_delete'); ?></a>
                        <?php endif ?>
                    </div>
            ...
            <!--iki tampil table'e-->
            <div id='ajax_list' class="ajax_list table-responsive csBar">
                <?php echo $list_view ?>
            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group input-group input-group-sm">
                                        ...
                                        <span class="input-group-btn">
                                            ...
                                            <button type="button" value="<?php echo $this->l('list_clear_filtering'); ?>" id='search_clear' class="search_clear btn btn-default btn-flat"><?php echo $this->l('form_button_clear'); ?></button>
                                        </span>
                                    </div>
                                </div>
                                <div class="col-md-6">
