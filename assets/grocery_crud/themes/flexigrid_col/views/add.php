...
$this->set_js_lib($this->default_theme_path . '/flexigrid_col/js/jquery.form.js');
$this->set_js_lib($this->default_javascript_path . '/jquery_plugins/jquery.form.min.js');
$this->set_js_config($this->default_theme_path . '/flexigrid_col/js/flexigrid-add.js');
...
<div class="flexigrid crud-form box" style='width: 100%;' data-unique-hash="<?= $unique_hash; ?>">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-plus-circle fa-fw"></i> <?= $subject; ?> <?= $this->l('form_add') . ' '; ?></h3>
    </div>

    <?php
    $formAttr = 'method="post" class="form-' . $formType . '" id="crudForm" autocomplete="off" enctype="multipart/form-data"';
    echo form_open($insert_url, $formAttr);
    ?>
