<?php
    $this->set_css($this->default_theme_path.'/quick_add/css/bootstrap.min.css');
    $this->set_css($this->default_theme_path.'/quick_add/css/bootstrap-theme.min.css');
    $this->set_css($this->default_theme_path.'/quick_add/css/datatables-bootstrap.min.css');
    $this->set_css($this->default_theme_path.'/quick_add/css/pnotify.custom.min.css');
    $this->set_css($this->default_theme_path.'/quick_add/css/datatables.css');
    $this->set_css($this->default_theme_path.'/quick_add/extras/TableTools/media/css/TableTools.css');
    ...
    $this->set_js_lib($this->default_theme_path.'/quick_add/js/jquery.dataTables.min.js');
    $this->set_js_lib($this->default_theme_path.'/quick_add/js/datatables-bootstrap.min.js');
    $this->set_js($this->default_theme_path.'/quick_add/js/pnotify.custom.min.js');
    $this->set_js($this->default_theme_path.'/quick_add/js/datatables.js');
    $this->set_js($this->default_theme_path.'/quick_add/extras/TableTools/media/js/ZeroClipboard.js');
    $this->set_js($this->default_theme_path.'/quick_add/extras/TableTools/media/js/TableTools.min.js');
?>
