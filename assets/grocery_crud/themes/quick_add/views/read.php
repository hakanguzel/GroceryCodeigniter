<?php $this->set_css($this->default_theme_path.'/quick_add/css/bootstrap.min.css'); ?>
<?php $this->set_css($this->default_theme_path.'/quick_add/css/bootstrap-theme.min.css'); ?>
